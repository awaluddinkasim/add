<x-layout title="Operator">
    <div class="card">
        <x-offcanvas title="Tambah Operator" label="Tambah">
            <x-errors />

            <form action="{{ route('operator.store') }}" method="post" autocomplete="off">
                @csrf
                <div class="mb-3">
                    <label for="nameInput" class="block text-sm font-medium mb-2 dark:text-white">Nama Operator</label>
                ...
                <div class="mb-3">
                    <label for="emailInput" class="block text-sm font-medium mb-2 dark:text-white">Email</label>
                ...
                <div class="mb-3">
                    <label for="passwordConfirm" class="block text-sm mb-2 dark:text-white">Konfirmasi Password</label>
                    <div class="relative">
                ...
                <div class="mb-3">
                    <label for="noTelpInput" class="block text-sm font-medium mb-2 dark:text-white">No. Telepon</label>
